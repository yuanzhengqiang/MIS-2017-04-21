...
<%@ page import="weixin.tenpay.RequestHandler" %>
<%@ page import="weixin.tenpay.ResponseHandler" %>   
<%@ page import="weixin.tenpay.client.ClientResponseHandler" %>    
<%@ page import="weixin.tenpay.client.TenpayHttpClient" %>
<%@ page import="weixin.tools.SignUtil" %>
...
alert("s");
//密钥
String key = SignUtil.PARTNER_KEY;
