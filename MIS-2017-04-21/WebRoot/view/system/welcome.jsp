...
<body>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="###"
					style="width:auto;background: url(images/logo.png) no-repeat 0 10px"><span>体检系统</span>
				</a>
				...
				<ul class="nav navbar-nav navbar-right user-nav">
					<li class="dropdown profile_menu"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"> <img
							src="images/avatar2.jpg" /> <span id="accountNickname"></span>
							<b class="caret"></b> </a>
	...
	<div id="cl-wrapper" class="fixed-menu">
				...
				<div class="menu-space">
					<div class="content">
						<div class="side-user">
							...
							<div class="info">
								<a href="#"></a> <img src="images/state_online.png"
		...
		<iframe id="welcomeCenter" scrolling="auto" frameborder="0"
			src="###" style="width: 100%; height: 99.5%;"> </iframe>
		<!-- 中间栏结束 -->
	</div>
