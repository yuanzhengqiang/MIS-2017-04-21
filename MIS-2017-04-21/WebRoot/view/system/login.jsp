...
.middle-login1{    width: 450px;z-index:22;
    right: 120px;
    top: 120px;
    position: absolute;
    margin:0}
.fskxiaoge{position: absolute; bottom:0;z-index:20;
animation:mymove 5s ease  1;
-webkit-animation: mymove 5s ease   1
-moz-animation: mymove 5s ease  1;
...
#password:-webkit-autofill {
 ...
 #loginbtn{padding:5px 30px;font-size:16px;}
 .foot{text-align:center !important;margin-top:15px;margin-bottom:20px}
		...
		<div class="middle-login1">
			<div class="block-flat">				
					...
					<div class="content">
						...
						<img src="" /></h3>
						<h3 class="title" style="text-align:center;">体检管理系统</h3>
						...
						<div class="form-group " >
							...
							<div class="col-sm-12 text-center" style="margin-top:-15px">
								<label class="checkbox-inline"> <input
									id="rememberUsername" type="checkbox" checked="" name="rad1"
									class="icheck">记住用户名</label> <label class="checkbox-inline">
									<input id="rememberPasswd" type="checkbox" checked=""
									name="rad1" class="icheck">记住密码</label>
