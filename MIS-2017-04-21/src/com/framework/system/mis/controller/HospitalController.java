...
import com.framework.system.mis.handler.HospitalHandler;
import com.framework.system.mis.service.HospitalService;
import com.framework.system.util.JsonUtil;

@RequestMapping("/hospital")
@Controller
public class HospitalController {
	private static Logger logger = Logger.getLogger(HospitalController.class);
	/**
	 * 处理器
	 */
	private HospitalHandler hospitalHandler = HospitalHandler.getInstance();
	/**
	 * 服务类
	 */
	...
	public ModelAndView center(HttpServletRequest request) {
		ModelAndView mav = new ModelAndView("hospitalManagement/hospitalList");
		return mav;
	}
	...
	public String query(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			String rep = hospitalHandler.doHandler(1, action, reqmsg, request,
					response);
