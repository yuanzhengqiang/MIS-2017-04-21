...
import com.framework.system.mis.handler.HospitalDetectingItemRelationHandler;
import com.framework.system.mis.service.HospitalDetectingItemRelationService;
import com.framework.system.util.JsonUtil;

@RequestMapping("/hospitalDetectingItemRelation")
@Controller
public class HospitalDetectingItemRelationController {
	private static Logger logger = Logger
			.getLogger(HospitalDetectingItemRelationController.class);
	/**
	 * 处理器
	 */
	private HospitalDetectingItemRelationHandler hospitalDetectingItemRelationHandler = HospitalDetectingItemRelationHandler
			.getInstance();
	/**
	 * 服务类
	 */
	...
	public AjaxJson del(HttpServletRequest request) {
		...
		if (ids != null && !"".equals(ids)) {
			boolean falg = hospitalDetectingItemRelationService.del(ids);
			if (falg) {
				result = "success";
				des = "删除成功";
			}
	...
	public String query(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			String rep = hospitalDetectingItemRelationHandler.doHandler(1,
