...
import com.framework.system.mis.pack.PayInfoPack;
import com.framework.system.mis.parse.PayInfoParse;
	...
	public String doHandler(int type, String command, String reqStr,
		...
		try {
			...
			if ("save".equals(action)) {
				...
				// // 根据数据权限 增加查询条件
				// queryMap = systemService.addDataRuleByRoles("PayInfoEntity",
				// queryMap, request);
				// result = payInfoService.getListByCondition(queryMap,
				// orderList,
