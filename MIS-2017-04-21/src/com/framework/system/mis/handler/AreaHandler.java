...
import com.framework.system.mis.pack.AreaPack;
import com.framework.system.mis.parse.AreaParse;
import com.framework.system.mis.service.AreaService;
	...
	public String doHandler(int type, String command, String reqStr,
		...
		try {
			...
			if ("save".equals(action)) {
				...
				// // 根据数据权限 增加查询条件
				// queryMap = systemService.addDataRuleByRoles("AreaEntity",
				// queryMap, request);
