...
import com.framework.system.mis.pack.HospitalPack;
import com.framework.system.mis.parse.HospitalParse;
	...
	public String doHandler(int type, String command, String reqStr,
		...
		try {
			...
			if ("save".equals(action)) {
				...
				// // 根据数据权限 增加查询条件
				// queryMap = systemService.addDataRuleByRoles("HospitalEntity",
				// queryMap, request);
