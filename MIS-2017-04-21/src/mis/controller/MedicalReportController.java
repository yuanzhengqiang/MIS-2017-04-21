...
import mis.handler.MedicalReportHandler;
...
public class MedicalReportController {
	private static Logger logger = Logger.getLogger(MedicalReportController.class);	
	/**
	 * 处理器
	 */
	private MedicalReportHandler medicalReportHandler = MedicalReportHandler.getInstance();
	/**
	 * 服务类
	 */
	...
	public String query(HttpServletRequest request,HttpServletResponse response) {
		...
		try {
		    ...
		    String rep = medicalReportHandler.doHandler(1, action, reqmsg, request, response);
