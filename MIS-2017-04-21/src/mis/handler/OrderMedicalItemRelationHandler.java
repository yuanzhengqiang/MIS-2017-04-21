...
import mis.pack.OrderMedicalItemRelationPack;
import mis.parse.OrderMedicalItemRelationParse;
		...
		try {
			...
			if ("save".equals(action)) {
				...
				result = orderMedicalItemRelationService.getById(id,
				 ...
				 result = orderMedicalItemRelationService.getListByCondition(queryMap,orderList,
				 pageno, pagesize,orderEntityShow,medicalItemShow);
