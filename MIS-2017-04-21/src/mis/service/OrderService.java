...
public class OrderService {
	 ...
	 * @param obj
	 */
	public OrderEntity getById(Integer id, Boolean parentOrderShow,
			Boolean childOrderListShow, Boolean servicePersonShow,
	 ...
	 */
	public List<OrderEntity> getListByCondition(Map<String, Object> queryMap,
			List<OrderVO> orderList, Boolean parentOrderShow,
			Boolean childOrderListShow, Boolean servicePersonShow,
			Boolean medicalReportShow) {
		List<OrderEntity> returnlist = null;
		List<Object> list = null;
		...
		int a = 0;
		if (parentOrderShow != null && parentOrderShow.booleanValue()) {
			a++;
		}
		if (childOrderListShow != null && childOrderListShow.booleanValue()) {
			a++;
		}
		if (servicePersonShow != null && servicePersonShow.booleanValue()) {
			a++;
	...
	public PageList getListByCondition(Map<String, Object> queryMap,
			...
			Boolean parentOrderShow, Boolean childOrderListShow,
	 ...
	 * @param obj
	 */
	public boolean del(Integer id, Boolean delParentOrder,
			Boolean delChildOrderList, Boolean delServicePerson,
	...
	public boolean delList(Map<String, Object> queryMap,
			Boolean delParentOrderList, Boolean delChildOrderList,
		...
		if (qc.getQueryNextCondition() != null) {
			...
			try {
				tx.beginTransaction();
				// 删除关联信息
				if (delChildOrderList != null
						&& delChildOrderList.booleanValue()) {
